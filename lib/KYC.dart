...
class _KYC extends State<KYC> {
  ...
  Map<String, String> professionRequirements = {
    "Chef": "1. Culinary Arts Degree/Certification\n2. Food Safety Certificate\n3. Experience Letter",
    "Personal Care Assistant": "1. Medical Education Certificate\n2. Background Check\n3. First Aid/CPR Certification",
    "Driver": "1. Valid Driver’s License\n2. Background Check\n3. Insurance Proof\n4. Driving Record",
    "Home/Security Guard": "1. ID Card\n2. Background Check\n3. Security Training/Certification",
    "Elderly/Elder Companion": "1. Background Check\n2. Health and Wellness Certification\n3. First Aid/CPR",
    "Babysitter": "1. Background Check\n2. CPR/First Aid Certification\n3. Experience Letters",
    "Cleaner": "1. ID Card\n2. Proof of Residence\n3. Employment History\n4. References",
    "Housekeeper": "1. ID Card\n2. References\n3. Employment History\n4. Background Check",
    "Paramedics": "1. Medical Education Certificate (Paramedic Training)\n2. CPR/First Aid Certification\n3. Licensure",
    "Occupational Therapists": "1. Medical Education Certificate (Occupational Therapy Degree)\n2. Licensure\n3. Background Check",
    "Physiotherapists": "1. Medical Education Certificate (Physiotherapy Degree)\n2. Licensure\n3. Background Check",
    "Home Health Aids": "1. Medical Education Certificate\n2. First Aid/CPR Certification\n3. Background Check",
    "Certified Nursing Assistant": "1. Medical Education Certificate (CNA Certification)\n2. CPR/First Aid Certification\n3. Background Check",
    "Licensed Practical Nurses": "1. Medical Education Certificate (LPN Degree)\n2. Licensure\n3. Background Check",
    "Registered Nurses": "1. Medical Education Certificate (RN Degree)\n2. Licensure\n3. Background Check\n4. CPR Certification"
  };
            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 10),
                    Text("Personal Information", style: TextStyle(fontSize: 20, color: Colors.black),),
                    SizedBox(height: 10),
                    // Full name
                    Container(
                      height: 50,
                        ...
                        children: [
                          ...
                          Text(
                            AadharCard == null
                                ...
                                ? AadharCard!.path.split('/').last.substring(0, 13) + '...' // Truncate and add ellipsis
                        ...
                        children: [
                          ...
                          Text(
                            PassportSizePhoto == null
                                ? "Not Selected"
                                : (PassportSizePhoto!.path.split('/').last.length > 10
                                ? PassportSizePhoto!.path.split('/').last.substring(0, 13) + '...' // Truncate and add ellipsis
                        ...
                        children: [
                          ...
                          Text(
                            SelfVideo == null
                                ...
                                ? SelfVideo!.path.split('/').last.substring(0, 13) + '...' // Truncate and add ellipsis
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text("Profession Verification", style: TextStyle(fontSize: 20),),
                          Text("Please provide at least one of the following documents to verify your Chef profession.", style: TextStyle(fontSize: 12, fontStyle: FontStyle.italic),),
                          Text(checkprofession(), style: TextStyle(fontSize: 12, fontStyle: FontStyle.italic),)
                        ],
                      ),
                    ),
                    SizedBox(height: 10),
                        ...
                        children: [
                          ...
                          Text(
                            ProfessionVerDoc == null
                                ? "Not Selected"
                                : (ProfessionVerDoc!.path.split('/').last.length > 10
                                ? ProfessionVerDoc!.path.split('/').last.substring(0, 13) + '...' // Truncate and add ellipsis
                        ...
                        children: [
                          ElevatedButton(
                              onPressed: () async {
                                ...
                                if(PassportSizePhoto != null && AadharCard != null && SelfVideo != null && ProfessionVerDoc != null){


                                User? user = await FirebaseAuth.instance.currentUser;

                                UploadTask uploadTask = FirebaseStorage.instance.ref().child("VerificationDoc/PassportPhoto/${user?.uid}").putFile(PassportSizePhoto!);

                                uploadTask = FirebaseStorage.instance.ref().child("VerificationDoc/AadharCard/${user?.uid}").putFile(AadharCard!);

                                uploadTask = FirebaseStorage.instance.ref().child("VerificationDoc/SelfVideo/${user?.uid}").putFile(SelfVideo!);

                                uploadTask = FirebaseStorage.instance.ref().child("VerificationDoc/ProfessionalDoc/${user?.uid}").putFile(ProfessionVerDoc!);

                                await FirebaseFirestore.instance.collection(Skill.toLowerCase()).doc(user?.uid).update({
                                  'Verified':"pending",
                                });
