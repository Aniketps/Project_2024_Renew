                        ...
                        ElevatedButton(
                          onPressed: () async {
                            ...
                            if (HourRate.text.isNotEmpty &&
                                ...
                                TravelingCharges.text.isNotEmpty) {
                              try {
                                User? user = FirebaseAuth.instance.currentUser;
                                if (user != null) {
                                  String currentUID = user.uid;
                                  int hourRate = int.parse(HourRate.text);
                                  int dayRate = int.parse(DayRate.text);
                                  int dayShift = int.parse(DayShift.text);
                                  int travelingCharges = int.parse(TravelingCharges.text);
                                  ...
                                  await FirebaseFirestore.instance.collection(Skill).doc(currentUID).update({
                                    ...
                                    "Day_Rate": dayRate,
                                    "Day_Shift": dayShift,
                                    "Traveling_Charges": travelingCharges,
                                  });
                              ...
                              Fluttertoast.showToast(
                                msg: "Please fill all fields with valid numbers",
                                toastLength: Toast.LENGTH_SHORT,
                                gravity: ToastGravity.BOTTOM,
                              );
                            }
